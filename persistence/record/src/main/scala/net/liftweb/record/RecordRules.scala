...
object RecordRules extends Factory {
  ...
  /**
    ...
    * current request
    */
  val displayName: FactoryMaker[(GenericRecord[_, _, _], Locale, String) => String] =
    new FactoryMaker[(GenericRecord[_, _, _], Locale, String) => String]((m: GenericRecord[_, _, _], l: Locale, name: String) => name) {}
}
